...
export default function AdminCoursesCreate({ institutions, disciplines, levels, course_scopes, semesters }: Props) {
        ...
        <AdminLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4 p-4 md:p-6">
                <div className="flex items-center justify-between">
                    <h1 className="font-display text-2xl font-bold tracking-tight">Create Course</h1>
                </div>
