        ...
        <div className="space-y-3">
            {isSubmitted ? (
                ...
                <input
                    ...
                    className={cn(
                        'w-full rounded-lg border bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:border-primary focus:ring-primary/20',
                        'border-border',
                    )}
                    style={{ fontFamily: 'var(--font-content)' }}
                />
